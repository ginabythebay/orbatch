...
| --- | --- | --- |
| `tools/batch` | `batch` | Drives agent VMs over a stack of issues (`batch run`), or over one branch (`batch vwt`) |
...
| `packages/ghgql` | — | Shared GitHub GraphQL transport, repo detection, issue label and body mutations, and the batch-label vocabulary |
